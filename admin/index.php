 ...
 <nav class="navbar navbar-default">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand"><span class="glyphicon glyphicon-music" aria-hidden="true"></span> setu music</a>
    </div>
...
<div class="form-group">
      <label for="select" class="col-lg-3 control-label">Homepage  Country</label>
      <div class="col-lg-9">
